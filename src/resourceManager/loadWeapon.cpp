...
int ef::ResourceManager::LoadWeapon(bool reset)
{
  if(reset)
    weaponConf.clear();
  std::vector<std::string> conf = {"LEsTIK.dabsic", "miniGun.dabsic", "rifle.dab", "pistol.dab", "sniperRifle.dab", "artilleryGun.dab", "cannon.dab", "rocketLauncher.dab", "rocketBarage.dab"};
