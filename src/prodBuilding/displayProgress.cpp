...
void ef::ProdBuilding::displayProgress(ef::Bpixelarray &px,
				       ef::AcuPos caseSize,
				       ef::AcuPos camStart,
				       double zoom)
{
  ...
  if (unitProd.size() > 0)
    {
      ...
      double tempon = (timeLeft * size.x) / unitProd[0].timeToProduce;
      //std::cout << "displayProgress in prodbuilding timeToProduce : " << unitProd[0].timeToProduce << " timeLeft : " << timeLeft << std::endl;
