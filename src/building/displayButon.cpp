...
void ef::Building::displayButon(ButonManager &manager,
  ...
  while(tmp < butons.size())
    {
      ...
      manager.add(groupButon, print, square, Case, outside, background, sprits[pxName], action, , Case);
    }
}
