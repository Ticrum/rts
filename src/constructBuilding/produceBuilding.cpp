  ...
  if (timeLeft <= 0)
    {
	  ...
	  if (buildingProd[0].type == PRODUCTION)
	    newBuilding.reset(new ProdBuilding(buildingProd[0], imgs[buildingProd[0].img], tempPos, rand(), alegence, weaponsConf));
	  else if (buildingProd[0].type == CONSTRUCT)
	    newBuilding.reset(new ConstructBuilding(buildingProd[0], imgs[buildingProd[0].img], tempPos, rand(), alegence, weaponsConf));
	  else if (buildingProd[0].type == TECH)
	    newBuilding.reset(new TechBuilding(buildingProd[0], imgs[buildingProd[0].img], tempPos, rand(), alegence, weaponsConf));
	  else
